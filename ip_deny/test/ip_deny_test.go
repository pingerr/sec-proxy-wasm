...
func BenchmarkIp(b *testing.B) {
	...
	for n := 0; n < b.N; n++ {
		...
		myRadixTree.RadixTest(ipArr) //BenchmarkIp-4               2241            527007 ns/op          639045 B/op         13 allocs/op
		//art.RadixTest(ipArr) //BenchmarkIp-4               1316            873632 ns/op          260916 B/op       6523 allocs/op
	}
}
