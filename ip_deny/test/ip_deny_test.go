...
func BenchmarkIp(b *testing.B) {
	...
	for n := 0; n < b.N; n++ {
		...
		//BenchmarkIp-4               8013            147115 ns/op              72 B/op          0 allocs/op
		//BenchmarkIp-4               7156            149423 ns/op              81 B/op          0 allocs/op
		//BenchmarkIp-4               8012            168108 ns/op              72 B/op          0 allocs/op
